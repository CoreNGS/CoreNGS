...
#
# This makefile is simple by design. The CoreNGS make automatically reads
...
# used for upgrading an existing CoreNGS system, because the kernel is
...
.else
world: .PHONY
	@echo "WARNING: make world will overwrite your existing CoreNGS"
	@echo "installation without also building and installing a new"
	@echo "kernel.  This can be dangerous.  Please read the handbook,"
	@echo "'Rebuilding world', for how to upgrade your system."
	@echo "Define DESTDIR to where you want to install CoreNGS,"
